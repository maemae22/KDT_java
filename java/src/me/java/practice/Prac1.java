package me.java.practice; // 패키지 (클래스 집합, 이름은 소문자로 작성)

public class Prac1 { // 클래스 (이름은 대문자로 작성, Upper Camel Case)

    public static void main(String[] args) { // 메인 함수 (프로그램 실행 시 자동으로 호출되어 순차적으로 문장이 실행됨)
        /*
